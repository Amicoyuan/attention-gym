...
from ..kernel import per_block_int8_triton_kernel, qk_int8_pv_fp16_forward_kernel
...
def sageattn_qk_int8_pv_fp16_triton(
    ...
    **kwargs: Any,
    ...
    """
    SageAttention with per-block INT8 quantization for Q and K
    ...
    o, lse = qk_int8_pv_fp16_forward_kernel(
        q_int8,
        k_int8,
        v,
        q_scale,
